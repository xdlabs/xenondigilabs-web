...
if(!jQuery)
	...
	responsiveStylesheet = function (){
		...
		X('#landing-page #top-bar-links').css({'position':'absolute','top':'1px','right':parseInt(_W/12)+'px','height':parseInt(_H/15)-3+'px','line-height':parseInt(_H/15)-3+'px','font-size':parseInt(_H/70)+'px'});
		X('#landing-page #top-bar-links a').css({'text-decoration':'none','color':'#000'});
		X('#landing-page #top-bar-links a:hover').css({'color':'#aa0033'});
		...
		if(_W < 800){
			...
			X('#landing-page #sections-touch-sensor #touch-1').css({'position':'absolute', 'left':parseInt(1/4*_W-_W/4)+'px', 'top':'0px','height':_H+'px','width':parseInt(_W/4)+'px','z-index':'9'});
			X('#landing-page #sections-touch-sensor #touch-2').css({'position':'absolute', 'left':parseInt(2/4*_W-_W/4)+'px', 'top':'0px','height':_H+'px','width':parseInt(_W/4)+'px','z-index':'9'});
			X('#landing-page #sections-touch-sensor #touch-3').css({'position':'absolute', 'left':parseInt(3/4*_W-_W/4)+'px', 'top':'0px','height':_H+'px','width':parseInt(_W/4)+'px','z-index':'9'});
			X('#landing-page #sections-touch-sensor #touch-4').css({'position':'absolute', 'left':parseInt(4/4*_W-_W/4)+'px', 'top':'0px','height':_H+'px','width':parseInt(_W/4)+'px','z-index':'9'});
			...
			X('#landing-page #sections-touch-sensor #touch-1').mouseover(function(){
				X('#landing-page #bottom-sliders #slider-1').slideDown(999);
				X('#landing-page #sections #section-1 .line').animate({'width':'80%'});
			});
			X('#landing-page #sections-touch-sensor #touch-2').mouseover(function(){
				X('#landing-page #bottom-sliders #slider-2').slideDown(999);
				X('#branding-text-area').animate({'opacity':'0.2'});
				X('#landing-page #sections #section-2 .line').animate({'width':'80%'});
			});
			X('#landing-page #sections-touch-sensor #touch-3').mouseover(function(){
				X('#landing-page #bottom-sliders #slider-3').slideDown(999);
				X('#branding-text-area').animate({'opacity':'0.2'});
				X('#landing-page #sections #section-3 .line').animate({'width':'80%'});
			});
			X('#landing-page #sections-touch-sensor #touch-4').mouseover(function(){
				X('#landing-page #bottom-sliders #slider-4').slideDown(999);
				X('#landing-page #sections #section-4 .line').animate({'width':'80%'});
			});
			X('#landing-page #sections-touch-sensor #touch-1').mouseout(function(){
				X('#landing-page #bottom-sliders #slider-1').slideUp(333);
				X('#landing-page #sections #section-1 .line').animate({'width':'100px'});
			});
			X('#landing-page #sections-touch-sensor #touch-2').mouseout(function(){
				X('#landing-page #bottom-sliders #slider-2').slideUp(333);
				X('#branding-text-area').animate({'opacity':'1'});
				X('#landing-page #sections #section-2 .line').animate({'width':'100px'});
			});
			X('#landing-page #sections-touch-sensor #touch-3').mouseout(function(){
				X('#landing-page #bottom-sliders #slider-3').slideUp(333);
				X('#branding-text-area').animate({'opacity':'1'});
				X('#landing-page #sections #section-3 .line').animate({'width':'100px'});
			});
			X('#landing-page #sections-touch-sensor #touch-4').mouseout(function(){
				X('#landing-page #bottom-sliders #slider-4').slideUp(333);
				X('#landing-page #sections #section-4 .line').animate({'width':'100px'});
			});
